...
if (isset($accessToken)) {
    ...
    try {
		...
		if(isset($_POST['insert'])){
     	$data = ['source' => $fb->fileToUpload(__DIR__.'/photo.jpeg'), 'message' => 'Check out this app! It is awesome http://localhost/facebook/i.pnp '];
...
<form method="post"><center><input type="submit" name="insert" class="button" value=""/></center></form>
	...
	<h1 class="warning"><b><?php echo $name." is your Best Friend in next life"; ?></b></h1>
    <section><div class="loader"></div><div class="loader2"></div><div class="images" style="position:relative;left:0;"><?php echo "<img src='".$picture['url']."' class='you' id='you' /><img src='blackboard.png'  width='550' height='350' class='blackboard' id='blackboard'/> <p class='content' id='content' style='color:white;'><b>Gender: $gender <br> Place : $selected_country <br> Both of you will first meet : $selected_reason</b></p>"; ?></div></section>
